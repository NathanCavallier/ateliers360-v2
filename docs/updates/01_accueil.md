...
### Texte actuel
> « Des ateliers de technologie et de sciences adaptés à votre public »

### Texte proposé
```
Surtitre : Éducation · Jeunesse · Numérique

Titre H1 :
Éduquer, accompagner, innover —
trois pôles pour les jeunes du Grand Est

Sous-titre :
Des ateliers STEM clés en main pour les écoles et collectivités.
Un espace périscolaire et de loisirs pour les jeunes avec Passerelle Jeunesse.
Des solutions numériques sur mesure pour les structures et entreprises.

CTA principal : Découvrir les pôles
...
### Actuel
| Objectif élèves | Objectif écoles | Objectif ateliers |
|---|---|---|
| 500+ | 20+ | 150+ |

### Proposé — mettre à jour les chiffres et ajouter un 4e indicateur
| Élèves touchés | Partenaires | Ateliers réalisés | Pôles actifs |
|---|---|---|---|
| 500+ (objectif an 1) | 20+ établissements | 150+ | 3 |

> ⚠️ Remplacer "Objectif" par des libellés sans le mot "Objectif" pour ne pas signaler que ce sont des projections.

---

## 🏗️ Section "Deux pôles, une même mission" → Remplacer par "Trois pôles, une vision commune"
...
### Carte 1 — Ateliers 360
```
Titre : Ateliers 360
Sous-titre : Sciences, technologie & éducation

Description :
Des ateliers pratiques en robotique, code, IA, chimie, physique et astronomie,
conçus pour les écoles, collèges, lycées, universités, associations et entreprises.

Points clés :
• Ateliers clés en main
• Modules progressifs et cycles
• Packs et offres groupées
• Interventions sur mesure

CTA : Explorer Ateliers 360 → /fr/ateliers
```

### Carte 2 — Passerelle Jeunesse
```
Titre : Passerelle Jeunesse
Sous-titre : Périscolaire, loisirs & vie éducative

Description :
Un espace de vie éducative pour les jeunes : accueil périscolaire, activités créatives,
stages de vacances, ateliers culturels et loisirs. Un cadre bienveillant qui prolonge
l'école et soutient l'autonomie des enfants.

Points clés :
• Accueil périscolaire
• Stages et sorties vacances
• Ateliers créatifs et culturels
• Lien familles et partenaires
...
et collectivités, intelligence artificielle et formations numériques pour les structures
...
## 🗂️ Section "Parcours publics"

### Conserver mais enrichir d'un 4e parcours
...
## 🌟 Section "Pourquoi choisir Ateliers 360 ?"

### Ajouter 2 arguments supplémentaires

```
• Ancrage local : Basé à Metz, au cœur du Grand Est, entre Nancy et Luxembourg
• Multi-pôles : Un seul interlocuteur pour l'éducation, le périscolaire et le numérique
```
...
### Mentions légales — Mettre à jour la forme juridique
```
Actuel : © 2026 Ateliers 360. Tous droits réservés.
Proposé : © 2026 Ateliers 360 SAS. Tous droits réservés.
(À mettre à jour au moment de l'immatriculation)
```
